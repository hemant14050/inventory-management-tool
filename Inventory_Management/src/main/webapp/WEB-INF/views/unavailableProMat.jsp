...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
		...
		<nav class="navbar navbar-dark bg-primary">
		  <!-- Navbar content -->
		  	<span>
				...
				<a class="btn btn-dark" href="unavailableProMat" role="button"><b>Unavailable Processed Material</b></a>
			</span>
			<span>
		...
		<br>
		<div class="heading2">
    		<h2>Unavailable Processed Material</h2>
    	</div>
    	<hr>
