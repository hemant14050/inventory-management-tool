...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
		...
		<nav class="navbar navbar-dark bg-primary">
		  <!-- Navbar content -->
		  	<span>
				...
				<a class="btn btn-dark" href="addProMatForm" role="button"><b>Add Material</b></a>
		...
		<br>
		<div class="heading2">
	    		<h2>Add Processed Material</h2>
	    	</div>
	    	<hr>
	    	<form action="addRawMat" method="post">
			  <div class="form-row">
			  ...
			  <div class="form-group">
				<b><label for="inputPassword4">Material Name:</label></b>
		        <input type="text" name="itemName" class="form-control" id="inputPassword4" placeholder="Enter Material Name" required>		    
			  </div>
			  <div class="form-row">		
				<div class="form-group col-md-6">
			    ...
			    <div class="form-group col-md-6">
			      <b><label for="inputEmail4">Material Unit:</label></b>
			      <select name="itemUnit" id="inputState" class="form-control" required>
			    ...
			    <div class="form-group col-md-6">
			      <b><label for="inputEmail4">Cost Per Unit:</label></b>
			      <input type="number" min="1" name="costPerUnit" class="form-control" id="inputEmail4" placeholder="Enter Cost Per Unit" required>
			    </div>		
			  </div>
		
			  <button type="submit" class="btn btn-primary"><b>Add Material</b></button>
			</form>
			<br>
			<hr>
			<footer class="footer">
