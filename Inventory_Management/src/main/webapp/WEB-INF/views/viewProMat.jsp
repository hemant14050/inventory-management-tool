...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
		...
		<nav class="navbar navbar-dark bg-primary">
		  <!-- Navbar content -->
		  	<span>
				...
				<a class="btn btn-dark" href="viewProMat" role="button"><b>View Material</b></a>
		...
		<br>
		<div class="heading2">
    		<h2>Available Processed Material</h2>
    	</div>
    	<hr>
    	<table class="table table-striped">
		  ...
		  <%
	    	List<ProcessedMaterial> processedMaterial= (List<ProcessedMaterial>) request.getAttribute("processedMaterial");
	      	for(ProcessedMaterial rm: processedMaterial)
	      	{
	      %>
		    <tr>
		      ...
		      <td><a href="deletee/<%=rm.getItemId() %>"><button type="button" class="btn btn-danger">Delete</button></a></td>
		    </tr>
		    <%
	      	}
		    %>
