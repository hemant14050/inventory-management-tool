<%@page import="com.hemant.model.IssuedProMaterial"%>
<%@page import="com.hemant.model.ProcessedMaterial"%>
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
		...
		<nav class="navbar navbar-dark bg-primary">
		  <!-- Navbar content -->
		  	<span>
				...
				<a class="btn btn-dark" href="viewProMatLog" role="button"><b>Processed Material Issue Log</b></a>
			</span>
			<span>
		...
		<br>
		<div class="heading2">
    		<h2>Processed Material Issue Log</h2>
    	</div>
    	<hr>
    	<table class="table table-striped">
		  ...
		  <tbody>
		  <%
	    	List<IssuedProMaterial> issuedProMaterialLog= (List<IssuedProMaterial>) request.getAttribute("issuedProMaterialLog");
	      	for(IssuedProMaterial rm: issuedProMaterialLog)
	      	{
	      %>
		    <tr>
		      <th scope="row"><%=rm.getIssueId() %></th>
		      <td><%=rm.getItemId() %></td>
		      <td><%=rm.getItemName() %></td>
		      <td><%=rm.getItemQuantity() %></td>
		      <td><%=rm.getIssuerName() %></td>
		      <td><%=rm.getIssueDate() %></td>
		    </tr>
		    <%
	      	}
		    %>
